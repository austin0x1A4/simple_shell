...
/**
 * clear_info_struct - Initializes the fields of the info_t struct to NULL/0.
...
/**
 * set_info_struct - Initializes the fields of the info_t struct.
 * @info: Pointer to the info_t struct.
 * @av: Argument vector.
 */
...
/**
 * free_info_struct - Frees the fields of the info_t struct.
 * @info: Pointer to the info_t struct.
